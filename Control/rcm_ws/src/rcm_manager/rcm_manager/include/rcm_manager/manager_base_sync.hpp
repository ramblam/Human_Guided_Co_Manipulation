...
namespace rcm_manager
{
  class ManagerBase
  {
    ...
    protected:
      ...
      void switch_controller(std::vector<std::string> activate_controllers,
      ...
      void load_compliant_controller_cb(const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
        std::shared_ptr<std_srvs::srv::Trigger::Response> response);

      void load_default_controller_cb(const std::shared_ptr<std_srvs::srv::Trigger::Request> request,
        std::shared_ptr<std_srvs::srv::Trigger::Response> response);
