...
namespace rcm_controllers
{
  ...
  protected:
    ...
    Eigen::Matrix<double, 6, 1> cumulative_error_; //!< Calculate cumulative (integral) error
    std::atomic<double> integral_stiffness_coefficent_; //!< Gain of the integral error, proportional to cartesian stiffness
    std::atomic<double> integral_leak_rate_; //!< Leak rate of the integral error
